    ...
    return (
        <div className='bg-blue-200'>
            <div className="p-8 max-w-6xl mx-auto min-h-screen">
                <h1 className="text-3xl font-bold text-[#720e9e] text-center mb-8">Our Aquatic Friends</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {fishList.map((fish) => (
                     
                        <div key={fish.id} className="border p-4 rounded-xl bg-white shadow-sm">
                            <img
                            ...
                            <p className="text-sm text-purple-600 font-semibold">{fish.breed} • {fish.age}</p>
                            <p className="text-gray-700 mt-2 text-sm">{fish.description}</p>
